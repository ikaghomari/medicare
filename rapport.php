...
<body> 
    ...
    <div id="content">
      ...
      <div class="form">
      <form method="POST" action="rapportNumAdd.php">
      <input type="text" class="form-field animation a3" id="Num" name="Num" placeholder="Entrer le 'ID' du patient"><br>   
          <center><input  type="submit" value="Continuer" class="form-field animation a4"/></center>
