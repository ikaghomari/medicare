...
<body>
   <header>  </header>
     ...
     <br>
    <center><h2><p>Voici votre table des services :</p></h2></center><br>
  <div id="content">
    
      <div class="icon-bar">
          <a class="active" href="medical.html"><i class="fa fa-home"></i>&nbsp;&nbsp;&nbsp;&nbsp;Sortir</a> 
          <a class="aff" href="afficherService.php"><i class="fas fa-tv"></i>&nbsp;&nbsp;&nbsp;&nbsp;Afficher les services</a> 
...
if ($result->num_rows > 0) {
    echo "<table><tr><th>N°</th><th>Nom service</th><th>Nom médecin spécialiste</th><th>Montant</th><tr>";
