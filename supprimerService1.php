...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["numero"]. "</td><td>". " " . $row["service"]. "</td><td>" . $row["medecinS"]. "</td><td>" . $row["montant"]. "</td> <td><a href='supprimerService2.php?numero=$row[numero]'style='color:red; padding: 11px 25px;border: none ;color: ##CD5C5C;text-decoration:none; font-size:15px;'>Supprimer </a></td></tr>";
    }
    echo "</table>";
