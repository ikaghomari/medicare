...
<head>
  <meta charset="utf-8">
    ...
    <title>Modifier table des services</title>
<style>
/* GENERAL */
*{
  margin: 0;
...
if ($result->num_rows > 0) {
    echo "<table><tr><th>N°</th><th>service</th><th>medecin</th><th>montant</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["numero"]. "</td><td>". " " . $row["service"]. "</td><td>" . $row["medecinS"]. "</td><td>" . $row["montant"]. "</td> <td><a href='modifierService2.php?numero=$row[numero]'style='color:red; padding: 11px 25px;border: none; ;color: ##CD5C5C;text-decoration:none; font-size:15px;'>Modifier </a></td></tr>";
    }
    echo "</table>";
