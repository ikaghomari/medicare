...
<?php 
  ...
  $Num=$_POST['Num'];
    ...
    if( !empty($Num)){
        ...
        if (mysqli_connect_error()) {
          ...
          $qry = "UPDATE patient SET Num=$Num WHERE id=$Num ";

          $result = mysqli_query($conn,$qry); //query executes

            echo '<h2>Le nouveau dossier a été bien ajouté</h2> ';
 ...
 <form method="POST" action="continue.php">
      <center>
      <br> 
    <b>N° du dossier :</b>  <input type="text" name="Num" class="form-field animation a3" value="<?php echo "$Num"?>"> <br><br>   
   <input  type="submit" value="continuer" class="form-field animation a4"/></center>
   </form>
</div>
